...
<!--=================================
 Main content -->
    ...
    $countersor=$db->prepare("SELECT * from counter where counter_id=:counter_id");
    $countersor->execute(array(
      'counter_id' => 1
    ));
    $countercek=$countersor->fetch(PDO::FETCH_ASSOC);
 ...
 <!--=================================
              ...
              <div class="container-fluid">
                ...
                <div class="col-lg-15">
                    <div class="callout callout-info">
                        <h5><i class="fas fa-info"></i> <?php echo $menu["countyo"]; ?></h5>


        <div class="col-lg-12">
          <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="index.php" class="default-color"><?php echo $menu["anasay"]; ?></a></li>
            <li class="breadcrumb-item active"> <?php echo $menu["countyo"]; ?></li>
          </ol>
        </div>
      </div>
  </div>
  <!-- main body -->
          ...
          <p>
            <div class="row">
               ...
               <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                  <a class="nav-link active show" id="counter1-tab" data-toggle="tab" href="#counter1" role="tab" aria-controls="counter1" aria-selected="true"> <i class="fa <?php echo $countercek['counter_icon1']; ?>"></i> Counter 1</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" id="counter2-tab" data-toggle="tab" href="#counter2" role="tab" aria-controls="counter2" aria-selected="false"><i class="fa <?php echo $countercek['counter_icon2']; ?>"></i> Counter 2 </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" id="counter3-tab" data-toggle="tab" href="#counter3" role="tab" aria-controls="counter3" aria-selected="false"><i class="fa <?php echo $countercek['counter_icon3']; ?>"></i> Counter 3 </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link" id="counter4-tab" data-toggle="tab" href="#counter4" role="tab" aria-controls="counter4" aria-selected="false"><i class="fa <?php echo $countercek['counter_icon4']; ?>"></i> Counter 4 </a>
                </li>
              </ul>
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade active show" id="counter1" role="tabpanel" aria-labelledby="counter1-tab">
                  <p>
                    <form action="function/islem.php" method="POST" enctype="multipart/form-data">

                      <div class="form-group">
                        <label ><b><?php echo $menu["countad"]; ?></b></label>
                        <input type="text" class="form-control" name="counter_ad1"   value="<?php echo $countercek['counter_ad1']; ?>" placeholder="Counter Adı giriniz..." >
                      </div>

                      <div class="form-group">
                        <label ><b><?php echo $menu["countsay"]; ?></b></label>
                        <input type="number" class="form-control" name="counter_sayi1"    value="<?php echo $countercek['counter_sayi1']; ?>" value="100">
                      </div>

                      <div class="form-group">
                        <label ><b><?php echo $menu["countic"]; ?></b> ( <i class="fa <?php echo $countercek['counter_icon1']; ?>"> </i> )  </label>
                        <div class="">
                          <select class=" form-control col-md-6 col-sm-6 col-xs-12"  style=" font-family: 'FontAwesome', 'sans-serif';" required="" name="counter_icon1" tabindex="-1">
                     ...
                     <button type="submit" name="counter1duzenle" class="dropdown-toggle-split btn btn-success "   aria-haspopup="true" aria-expanded="false"> <i class="ti-reload"> <?php echo $menu["sub"]; ?> </i></button>
            </div>
                   </form>
                 </p>
               </div>
               <div class="tab-pane fade" id="counter2" role="tabpanel" aria-labelledby="counter2-tab">
                <p>
                 ...
                 <form action="function/islem.php" method="POST" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    <label ><b><?php echo $menu["countad"]; ?></b></label>
                    <input type="text" class="form-control" name="counter_ad2"   value="<?php echo $countercek['counter_ad2']; ?>" placeholder="Counter Adı giriniz..." >
                  </div>

                  <div class="form-group">
                    <label ><b><?php echo $menu["countsay"]; ?></b></label>
                    <input type="number" class="form-control" name="counter_sayi2"    value="<?php echo $countercek['counter_sayi2']; ?>" value="100">
                  </div>

                  <div class="form-group">
                    <label ><b><?php echo $menu["countic"]; ?> </b> ( <i class="fa <?php echo $countercek['counter_icon2']; ?>"> </i> )  </label>
                    <div class="">
                      <select class=" form-control col-md-6 col-sm-6 col-xs-12"  style=" font-family: 'FontAwesome', 'sans-serif';" required="" name="counter_icon2" tabindex="-1">
                      <option value="fa-align-left">&#xf036; fa-align-left</option>
								<option value="fa-align-right">&#xf038; fa-align-right</option>
								<option value="fa-amazon">&#xf270; fa-amazon</option>
								<option value="fa-ambulance">&#xf0f9; fa-ambulance</option>
                 ...
                 <button type="submit" name="counter2duzenle" class="dropdown-toggle-split btn btn-success "   aria-haspopup="true" aria-expanded="false"> <i class="ti-reload"> <?php echo $menu["sub"]; ?> </i></button>
        </div>
               </form>

             </p>
           </div>
           <div class="tab-pane fade" id="counter3" role="tabpanel" aria-labelledby="counter3-tab">
            <p>
             ...
             <form action="function/islem.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-group">
                <label ><b><?php echo $menu["countad"]; ?></b></label>
                <input type="text" class="form-control" name="counter_ad3"   value="<?php echo $countercek['counter_ad3']; ?>" placeholder="Counter Adı giriniz..." >
              </div>

              <div class="form-group">
                <label ><b><?php echo $menu["countsay"]; ?></b></label>
                <input type="number" class="form-control" name="counter_sayi3"    value="<?php echo $countercek['counter_sayi3']; ?>" value="100">
              </div>

              <div class="form-group">
                <label ><b><?php echo $menu["countic"]; ?> </b> ( <i class="fa <?php echo $countercek['counter_icon3']; ?>"> </i> )  </label>
                <div class="">
                  <select class=" form-control col-md-6 col-sm-6 col-xs-12"  style=" font-family: 'FontAwesome', 'sans-serif';" required="" name="counter_icon3" tabindex="-1">
             ...
             <button type="submit" name="counter3duzenle" class="dropdown-toggle-split btn btn-success "   aria-haspopup="true" aria-expanded="false"> <i class="ti-reload"> <?php echo $menu["sub"]; ?> </i></button>
    </div>
           </form>
       ...
       <div class="tab-pane fade" id="counter4" role="tabpanel" aria-labelledby="counter4-tab">
        <p>
         ...
         <form action="function/islem.php" method="POST" enctype="multipart/form-data">
          ...
          <div class="form-group">
            <label ><b><?php echo $menu["countad"]; ?></b></label>
            <input type="text" class="form-control" name="counter_ad4"   value="<?php echo $countercek['counter_ad4']; ?>" placeholder="Counter Adı giriniz..." >
          </div>

          <div class="form-group">
            <label ><b><?php echo $menu["countsay"]; ?></b></label>
            <input type="number" class="form-control" name="counter_sayi4"    value="<?php echo $countercek['counter_sayi4']; ?>" value="100">
          </div>

          <div class="form-group">
            <label ><b><?php echo $menu["countic"]; ?> </b> ( <i class="fa <?php echo $countercek['counter_icon4']; ?>"> </i> )  </label>
            <div class="">
              <select class=" form-control col-md-6 col-sm-6 col-xs-12"  style=" font-family: 'FontAwesome', 'sans-serif';" required="" name="counter_icon4" tabindex="-1">
         ...
         <button type="submit" name="counter4duzenle" class="dropdown-toggle-split btn btn-success "   aria-haspopup="true" aria-expanded="false"> <i class="ti-reload"> <?php echo $menu["sub"]; ?></i></button>
</div>
       </form>
